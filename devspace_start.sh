...
- Run \`${COLOR_CYAN}${RUN_CMD}${COLOR_RESET}\` to start shepard
- ${COLOR_CYAN}Files will be synchronized${COLOR_RESET} between your local machine and this container

If you wish to run shepard in debug mode with delve, run:
  ...
  ${COLOR_CYAN}Note:${COLOR_RESET} shepard won't start until you connect with the debugger.
  ${COLOR_CYAN}Note:${COLOR_RESET} shepard will be stopped once you detach your debugger session.
